public class TicketTask implements Runnable {
    ...
    public static void main(String[] args) {
        Thread t1=new Thread(new TicketTask("Seating Assignment"));
...
/*
➡️Points to Remember:-
Each Runnable Object is a job and the thread class is responsible only for execution which makes this approach cleaner & more flexible.
